...
<template>
  <div v-if="result" class="card">
    ...
    <div class="flex items-center justify-between mb-4">
      <h2 class="section-label">AI Explanation</h2>
    ...
    >
      <svg v-if="!explainLoading" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    />
    <div v-if="explainError" class="mt-3 text-sm text-rose-400">
      {{ explainError }}
    </div>
